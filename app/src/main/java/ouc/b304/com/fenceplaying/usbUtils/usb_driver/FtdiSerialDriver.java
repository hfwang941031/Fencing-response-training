...
package ouc.b304.com.fenceplaying.usbUtils.usb_driver;
...
import ouc.b304.com.fenceplaying.usbUtils.HexDump;
import ouc.b304.com.fenceplaying.usbUtils.UsbId;
...
public class FtdiSerialDriver implements UsbSerialDriver {
    ...
    public FtdiSerialDriver(UsbDevice device) {
        mDevice = device;
        mPort = (UsbSerialPort) new FtdiSerialPort(mDevice, 0);
    }
    @Override
