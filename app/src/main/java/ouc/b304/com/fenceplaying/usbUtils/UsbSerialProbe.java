...
import ouc.b304.com.fenceplaying.usbUtils.usb_driver.Cp21xxSerialDriver;
import ouc.b304.com.fenceplaying.usbUtils.usb_interface.UsbSerialDriver;

/**
 * @author mike wakerly (opensource@hoho.com)
 */
public class UsbSerialProbe {

    private static UsbSerialProbe instance;
    private final ProbeTable mProbeTable;



    public static UsbSerialProbe getDefaultProbe() {
        if (instance == null) {
            synchronized (UsbUtil.class) {
                if (instance == null) {
                    instance = new UsbSerialProbe(getDefaultProbeTable());
                }
            }
        }
        return instance;
    }
    public UsbSerialProbe(ProbeTable probeTable) {
